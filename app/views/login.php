...
?>
<h1>Online-Banking<br />Willkommen</h1>
...
<form method="post" action="/app/login" class="aui">
  ...
  <div class="field-group">
    ...
    <input type="password" class="password" maxlength="128" name="password" id="password" required="required"></input>
  </div>
...
<p><a href="/app/register">Neuen Account registrieren</a></p>
<p><a href="/app/lost-password">Passwort vergessen?</a></p>
