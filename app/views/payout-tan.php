...
<p>Bitte &uuml;berpr&uuml;fen Sie Ihre Angaben und best&auml;tigen Sie die Auszahlung mit einer TAN:</p>
...
<form method="post" action="/app/payout" class="aui">
  ...
  <div class="buttons-container">
    <div class="buttons">
      <input type="hidden" name="owner" value="<?php echo htmlentities($params['owner']); ?>"></input>
      <input type="hidden" name="iban" value="<?php echo htmlentities($params['iban']); ?>"></input>
      ...
      <input class="button submit" type="submit" value="Auszahlen"></input>
    </div>
  </div>
</form>
